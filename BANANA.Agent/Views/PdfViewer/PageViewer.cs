...
namespace BANANA.Agent.Views.PdfViewer
{
	public class PageViewer : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.hsb.Location = new System.Drawing.Point(0, 457);
			this.hsb.Name = "hsb";
			this.hsb.Size = new System.Drawing.Size(423, 17);
			this.hsb.TabIndex = 0;
			...
			this.vsb.Location = new System.Drawing.Point(406, 0);
			this.vsb.Name = "vsb";
			this.vsb.Size = new System.Drawing.Size(17, 457);
			this.vsb.TabIndex = 1;
			...
			this.Size = new System.Drawing.Size(423, 474);
		...
		private void DrawRubberFrame()
		{
			...
			{
				Controllers.PdfViewer.GDI gdi = new Controllers.PdfViewer.GDI(g);
	...
	public class ShadowDrawing
	{
		...
		static Image shadowDownRight = new Bitmap(BANANA.Agent.Properties.Resources.tshadowdownright);
		static Image shadowDownLeft = new Bitmap(BANANA.Agent.Properties.Resources.tshadowdownleft);
		static Image shadowDown = new Bitmap(BANANA.Agent.Properties.Resources.tshadowdown);
		static Image shadowRight = new Bitmap(BANANA.Agent.Properties.Resources.tshadowright);
		static Image shadowTopRight = new Bitmap(BANANA.Agent.Properties.Resources.tshadowtopright);
